...
public class MovimientoCableNegroL4P1 : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.name.Equals("AgujeroUno", System.StringComparison.OrdinalIgnoreCase))
        {
            ...
            {
                objetoCogible.GetComponent<MouseDragCableNegroL4P1>().tocarSuelo = false;
                Transform hitoUnoAgujero = other.gameObject.transform.GetChild(0);
                mySequence.Append(objetoCogible.transform.DOMove(hitoUnoAgujero.position, 0.6f));
        ...
        else if (other.name.Equals("AgujeroDos", System.StringComparison.OrdinalIgnoreCase))
        {
            ...
            if (nombreObjetoConectado.Equals("", System.StringComparison.OrdinalIgnoreCase))
            {
                ...
                mySequence.Append(objetoCogible.transform.DOMove(hitoDosAgujero.position, 0.6f));
    ...
    private void OnTriggerExit(Collider other)
    {
        if (other.name.Equals("AgujeroUno", System.StringComparison.OrdinalIgnoreCase))
        {
            ...
            if (objetoCogible.name.Equals(nombreObjetoConectado)) {
                objetoCogible.GetComponent<MouseDragCableNegroL4P1>().tocarSuelo = true;
